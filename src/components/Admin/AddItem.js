...
import { addAdminItem } from "../../store/actions/adminActions";
  ...
  const validateImage = (e) => {
    ...
    if (files.length > 8) {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        //   return alert("One of the images is larger than 1mb");
        // }
        ...
        <ModalContent>
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            <ModalBody pb={6}>
              ...
              { uploading && <Spinner size="xl" color="blue.500" /> }
